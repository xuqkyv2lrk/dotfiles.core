...
if command -v glow &> /dev/null; then
    function glow() { command glow -p -w 150 "$@"; }
fi
...
#***
function helpers() {
    printf "${CMOCHA_PURPLE}Custom Shell Helpers${NC}\n\n"

    printf "${CMOCHA_BLUE}Search & Navigation${NC}\n"
    ...
    printf "${CMOCHA_BLUE}File Manager${NC}\n"
